...
void Response::parse_line1() {
  ...
  command_code =boost::lexical_cast<uint32_from_hex>(_line1.substr(0,4));
  //std::cout << "parsing: " << _line1.substr(4,4)  << std::endl;
  sequence_number =boost::lexical_cast<uint32_from_hex>(_line1.substr(4,4));
  //std::cout << "parsing: " << _line1.substr(8,4)  << std::endl;
  acknowledge_code =boost::lexical_cast<uint32_from_hex>(_line1.substr(8,4));
  //std::cout << "parsing: " << _line1.substr(12,4)  << std::endl;
  checksum =boost::lexical_cast<uint32_from_hex>(_line1.substr(12,4));
}
